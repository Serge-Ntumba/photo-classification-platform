...
* Review decision: `passes_automated_checks`

Or:

* Category: `invalid_file`
* Review decision: `fails_automated_checks`
...
* Image dimensions are from 300x300 through 5000x5000 pixels inclusive.
* Required metadata is present.
* Age is from 0 through 120 inclusive.
* Description length is no more than 1,000 characters.
