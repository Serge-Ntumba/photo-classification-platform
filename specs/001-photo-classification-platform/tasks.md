...
- [ ] T034 [P] [US2] Add integration tests for valid photo submission, object storage write, database persistence, and pending status in `services/main/apps/submissions/tests/test_submission_create.py`
- [ ] T035 [P] [US2] Add validation tests for missing metadata, invalid age, unsupported image type, oversized file, empty file, spoofed content type, and corrupted image in `services/main/apps/submissions/tests/test_submission_validation.py`
...
- [ ] T040 [US2] Implement submission create/list/retrieve serializers with metadata and file validation in `services/main/apps/submissions/serializers.py`
...
- [ ] T043 [US2] Implement classification job publisher using Celery/RabbitMQ payload rules in `services/main/apps/classification/publisher.py`
- [ ] T044 [US2] Integrate job publishing into successful submission creation without embedding image bytes, credentials, tokens, or demographic metadata in `services/main/apps/submissions/views.py`
...
- [ ] T047 [P] [US3] Add deterministic rule-based classifier tests for supported images, invalid files, unsupported types, incomplete metadata, and category priority in `services/classifier/tests/test_rule_based_classifier.py`
...
- [ ] T054 [US3] Implement deterministic rule-based submission-review classifier logic in `services/classifier/app/rules.py`
...
- [ ] T064 [P] [US4] Add admin API contract tests for `/api/admin/submissions/` list/detail filters in `tests/contracts/test_admin_submissions_api.py`
...
- [ ] T068 [US4] Implement admin-only submission list/detail views with metadata, status, category, decision, timestamp, search, and ordering filters in `services/main/apps/submissions/admin_views.py`
...
Task: T034 Add valid submission integration tests in services/main/apps/submissions/tests/test_submission_create.py
Task: T035 Add upload and metadata validation tests in services/main/apps/submissions/tests/test_submission_validation.py
...
Task: T047 Add classifier rule tests in services/classifier/tests/test_rule_based_classifier.py
